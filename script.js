$(document).ready(function() {
                ...
                $('.profile').html(`
                    <div class="row" id="profileData">
                        ...
                        <div class="col-xs-6" id="profileDetails">
                            ...
                            <p>Password<span id="colon">:</span><span> ${'*'.repeat(passwordLength)}</span></p>
                        </div>
                        <div class="col-xs-6" id="profileDetails">
    ...
    $('#registerBTN').on('click', function(){
        ...
        $.ajax({
            ...
            success: function(data) {
                const findUserId = data.result.find(user => user.id === id);
                const findUserPhone = data.result.find(user => user.phone === phone);
                const findUserMail = data.result.find(user => user.mail === mail);
